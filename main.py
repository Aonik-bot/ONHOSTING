...
app = Flask('')
NAME='@ONIK'  #Add what ever you want to desplay in bot like , i am ____ hostin bot 
@app.route('/')
def home():
...
# --- Configuration ---
TOKEN = '8921054049:AAFw7OIMQ4pw-ma6xUSUnQF9AAho51_bDLY'
OWNER_ID = 7923987636 # ADD YOUR USER ID 
...
IROTECH_DIR = os.path.join(BASE_DIR, 'inf')  # <--- FIXED LINE 53
DATABASE_PATH = os.path.join(IROTECH_DIR, 'bot_data.db')

# File upload limits
FREE_USER_LIMIT = 5 # <--- FIXED: Changed from 'o' to 5 (assuming a number was intended)
